...
class NavBarAssociationFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $l_association_association->setPath("/" . $this->slugify->slugify($l_association_association->getTitle()));
        ...
        $nos_sections_association->setPath("/" . $this->slugify->slugify($nos_sections_association->getTitle()));
        ...
        $infos_pratiques_association->setPath("/" . $this->slugify->slugify($infos_pratiques_association->getTitle()));
        ...
        $actualites_accueil_association->setPath("/" . $this->slugify->slugify($actualites_accueil_association->getName()));
        ...
        $notre_histoire_l_association_association->setPath("/" . $this->slugify->slugify($notre_histoire_l_association_association->getName()));
        ...
        $l_organigramme_l_association_association->setPath("/" . $this->slugify->slugify($l_organigramme_l_association_association->getName()));
        ...
        $documents_l_association_association->setPath("/" . $this->slugify->slugify($documents_l_association_association->getName()));
        ...
        $nos_partenaires_l_association_association->setPath("/" . $this->slugify->slugify($nos_partenaires_l_association_association->getName()));
        ...
        $basket_nos_sections->setPath("section-basket");
        ...
        $chorale_nos_sections->setPath("section-chorale");
        ...
        $danse_nos_sections->setPath("section-danse");
        ...
        $football_nos_sections->setPath("section-football");
        ...
        $gym_sportive_nos_sections->setPath("section-gym-sportive");
        ...
        $gym_tonique_nos_sections->setPath("section-gym-tonique-pilates-yoga");
        ...
        $loisirs_nos_sections->setPath("section-loisirs");
        ...
        $petanque_nos_sections->setPath("section-petanque");
        ...
        $tennis_de_table_nos_sections->setPath("section-tennis-de-table");
