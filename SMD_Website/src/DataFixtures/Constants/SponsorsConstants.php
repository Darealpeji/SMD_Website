...
class SponsorsConstants
{
    public const SPONSORS = [
        [
            'name' => 'Carrefour City',
            'path' => 'https://www.carrefour.fr/magasin/city-nantes-pontereau',
            'description' => '',
            'organizations' => [
        ...
        [
            ...
            'path' => 'https://www.facebook.com/BoulangerieDeslandes/',
            'description' => '',
            'organizations' => [
                OrganizationsConstants::ASSOCIATION,
                OrganizationsConstants::FOOTBALL
        ...
        [
            'name' => 'Sublim & Sens',
            'path' => 'https://www.sublimetsens.fr/',
            'description' => '',
            'organizations' => [
                OrganizationsConstants::ASSOCIATION,
                OrganizationsConstants::FOOTBALL
        ...
        [
            ...
            'path' => 'https://hair-line-coiffure-hair-salon.business.site/',
            'description' => '',
            'organizations' => [
                OrganizationsConstants::ASSOCIATION,
                OrganizationsConstants::FOOTBALL
        ...
        [
            ...
            'path' => 'https://www.facebook.com/profile.php?id=100042666103285&locale=fr_FR',
            'description' => '',
            'organizations' => [
                OrganizationsConstants::ASSOCIATION,
                OrganizationsConstants::FOOTBALL
        ...
        [
            ...
            'path' => 'https://concessions.peugeot.fr/le-loroux-bottereau/?location=LE+LOROUX+BOTTEREAU%7C0',
            'description' => '',
            'organizations' => [
                OrganizationsConstants::ASSOCIATION,
                OrganizationsConstants::FOOTBALL
        ...
        [
            ...
            'path' => 'https://www.sarlchristophe.com/',
            'description' => '',
            'organizations' => [
                OrganizationsConstants::ASSOCIATION,
        ...
        [
            'name' => 'Super U Dalby',
            'path' => 'https://www.magasins-u.com/magasin/superu-nantesdalby',
            'description' => '',
            'organizations' => [
                OrganizationsConstants::ASSOCIATION,
                OrganizationsConstants::BASKET,
    ...
    public const INSTITUTIONAL_PARTNERS = [
        [
        ...
        [
            ...
            'path' => 'https://foot44.fff.fr/',
            'description' =>    'District de Football de Loire-Atlantique<br>
                                Espace Fernand Sastre<br>
                                14, rue du Leinster<br>
                                CS 44502<br>
        ...
        [
            ...
            'path' => 'https://lfpl.fff.fr/wp-content/uploads/sites/20/prehome/prehome/index.html',
            'description' =>    'Adresse Territoire Atlantique : 172, boulevard des Pas Enchantés<br>
                                BP 63507<br>
                                44235 SAINT-SEBASTIEN SUR LOIRE Cedex<br>
                                Contact :<br>
        ...
        [
            ...
            'path' => 'https://metropole.nantes.fr/',
            'description' => '',
            'organizations' => [
                OrganizationsConstants::ASSOCIATION,
                OrganizationsConstants::FOOTBALL,
