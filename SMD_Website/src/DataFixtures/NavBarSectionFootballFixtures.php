...
class NavBarSectionFootballFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $accueil_football->setPath("section-football");
        ...
        $le_club_football->setPath($this->getReference(AssoSectionsFixtures::FOOTBALL)->getSlug() . "/" . $this->slugify->slugify($le_club_football->getTitle()));
        ...
        $nos_equipes_football->setPath($this->getReference(AssoSectionsFixtures::FOOTBALL)->getSlug() . "/" . $this->slugify->slugify($nos_equipes_football->getTitle()));
        ...
        $boutique_football->setPath($this->getReference(AssoSectionsFixtures::FOOTBALL)->getSlug() . "/" . $this->slugify->slugify($boutique_football->getTitle()));
        ...
        $infos_pratiques_football->setPath($this->getReference(AssoSectionsFixtures::FOOTBALL)->getSlug() . "/" . $this->slugify->slugify($infos_pratiques_football->getTitle()));
        ...
        $acces_licencies_football->setPath($this->getReference(AssoSectionsFixtures::FOOTBALL)->getSlug() . "/" . $this->slugify->slugify($acces_licencies_football->getTitle()));
        ...
        $actualites_accueil_football->setPath($accueil_football->getPath() . "/" . $this->slugify->slugify($actualites_accueil_football->getName()));
        ...
        $tv_smd_accueil_football->setPath($accueil_football->getPath() . "/" . $this->slugify->slugify($tv_smd_accueil_football->getName()));
        ...
        $notre_histoire_le_club_football->setPath($le_club_football->getPath() . "/" . $this->slugify->slugify($notre_histoire_le_club_football->getName()));
        ...
        $l_organigramme_le_club_football->setPath($le_club_football->getPath() . "/" . $this->slugify->slugify($l_organigramme_le_club_football->getName()));
        ...
        $p_e_f_le_club_football->setPath($le_club_football->getPath() . "/" . $this->slugify->slugify($p_e_f_le_club_football->getName()));
        ...
        $plan_cite_foot_le_club_football->setPath($le_club_football->getPath() . "/" . $this->slugify->slugify($plan_cite_foot_le_club_football->getName()));
        ...
        $reglement_charte_le_club_football->setPath($le_club_football->getPath() . "/" . $this->slugify->slugify($reglement_charte_le_club_football->getName()));
        ...
        $nos_partenaires_le_club_football->setPath($le_club_football->getPath() . "/" . $this->slugify->slugify($nos_partenaires_le_club_football->getName()));
        ...
        $seniors_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($seniors_nos_equipes_football->getName()));
        ...
        $u19_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($u19_nos_equipes_football->getName()));
        ...
        $u17_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($u17_nos_equipes_football->getName()));
        ...
        $u15_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($u15_nos_equipes_football->getName()));
        ...
        $u13_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($u13_nos_equipes_football->getName()));
        ...
        $u11_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($u11_nos_equipes_football->getName()));
        ...
        $u9_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($u9_nos_equipes_football->getName()));
        ...
        $u7_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($u7_nos_equipes_football->getName()));
        ...
        $groupement_feminin_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($groupement_feminin_nos_equipes_football->getName()));
        ...
        $veterans_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($veterans_nos_equipes_football->getName()));
        ...
        $loisirs_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($loisirs_nos_equipes_football->getName()));
        ...
        $arbitres_nos_equipes_football->setPath($nos_equipes_football->getPath() . "/" . $this->slugify->slugify($arbitres_nos_equipes_football->getName()));
        ...
        $inscriptions_infos_pratiques_football->setPath($infos_pratiques_football->getPath() . "/" . $this->slugify->slugify($inscriptions_infos_pratiques_football->getName()));
        ...
        $compte_acces_licencies_football->setPath($acces_licencies_football->getPath() . "/" . $this->slugify->slugify($compte_acces_licencies_football->getName()));
        ...
        $convocations_acces_licencies_football->setPath($acces_licencies_football->getPath() . "/" . $this->slugify->slugify($convocations_acces_licencies_football->getName()));
        ...
        $se_deconnecter_acces_licencies_football->setPath($acces_licencies_football->getPath() . "/" . $this->slugify->slugify($se_deconnecter_acces_licencies_football->getName()));
