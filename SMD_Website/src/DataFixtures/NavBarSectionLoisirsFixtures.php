...
class NavBarSectionLoisirsFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    private const SECTION = AssoSectionsFixtures::LOISIRS;
    ...
    public function loadNavBarLinks(ObjectManager $manager): void
    {
        ...
        $navBarLinksData = [
            ['Accueil', 'section-loisirs', 'home_section', 1],
    ...
    {
        $accueil = $this->navBarLinkRepository->findOneBy(['name' => 'Loisirs - Accueil']);
        $acces_membres = $this->navBarLinkRepository->findOneBy(['name' => 'Loisirs - Accès Membres']);
