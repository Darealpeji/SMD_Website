...
class NavBarSectionChoraleFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $accueil_chorale->setPath("section-chorale");
        ...
        $presentation_chorale->setPath($this->getReference(AssoSectionsFixtures::CHORALE)->getSlug() . "/" . $this->slugify->slugify($presentation_chorale->getTitle()));
        ...
        $nos_concerts_chorale->setPath($this->getReference(AssoSectionsFixtures::CHORALE)->getSlug() . "/" . $this->slugify->slugify($nos_concerts_chorale->getTitle()));
        ...
        $infos_pratiques_chorale->setPath($this->getReference(AssoSectionsFixtures::CHORALE)->getSlug() . "/" . $this->slugify->slugify($infos_pratiques_chorale->getTitle()));
        ...
        $acces_membres_chorale->setPath($this->getReference(AssoSectionsFixtures::CHORALE)->getSlug() . "/" . $this->slugify->slugify($acces_membres_chorale->getTitle()));
        ...
        $actualites_accueil_chorale->setPath($accueil_chorale->getPath() . "/" . $this->slugify->slugify($actualites_accueil_chorale->getName()));
        ...
        $repertoire_presentation_chorale->setPath($presentation_chorale->getPath() . "/" . $this->slugify->slugify($repertoire_presentation_chorale->getName()));
        ...
        $modalites_de_travail_presentation_chorale->setPath($presentation_chorale->getPath() . "/" . $this->slugify->slugify($modalites_de_travail_presentation_chorale->getName()));
        ...
        $compte_acces_membres_chorale->setPath($acces_membres_chorale->getPath() . "/" . $this->slugify->slugify($compte_acces_membres_chorale->getName()));
        ...
        $echo_raleur_acces_membres_chorale->setPath($acces_membres_chorale->getPath() . "/" . $this->slugify->slugify($echo_raleur_acces_membres_chorale->getName()));
        ...
        $lire_une_partition_acces_membres_chorale->setPath($acces_membres_chorale->getPath() . "/" . $this->slugify->slugify($lire_une_partition_acces_membres_chorale->getName()));
        ...
        $fichiers_mp3_acces_membres_chorale->setPath($acces_membres_chorale->getPath() . "/" . $this->slugify->slugify($fichiers_mp3_acces_membres_chorale->getName()));
        ...
        $pv_bureau_acces_membres_chorale->setPath($acces_membres_chorale->getPath() . "/" . $this->slugify->slugify($pv_bureau_acces_membres_chorale->getName()));
        ...
        $se_deconnecter_acces_membres_chorale->setPath($acces_membres_chorale->getPath() . "/" . $this->slugify->slugify($se_deconnecter_acces_membres_chorale->getName()));
