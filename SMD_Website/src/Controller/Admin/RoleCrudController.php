...
class RoleCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('name', "Nom du Rôle :")->setColumns(6),
            TextField::new('label', "Titre du Rôle :")->setColumns(6),
            AssociationField::new('association', 'Association :')->setColumns(6)->hideOnIndex(),
            AssociationField::new('sections', 'Section(s) :')->setColumns(6)->hideOnIndex(),
            AssociationField::new('members', 'Membres(s) :')->setColumns(6)->hideOnIndex(),
