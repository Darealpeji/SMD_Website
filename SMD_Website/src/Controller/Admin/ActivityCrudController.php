...
class ActivityCrudController extends AbstractCrudController
{
    ...
    {
        return $crud
            ->setEntityLabelInPlural("Disciplines Pratiquées")
            ->setEntityLabelInSingular("Discipline Pratiquée")
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            FormField::addFieldset("Informations de l'Activité"),
            TextField::new('name', "Nom Unique de la Discipline :")->setColumns(6),
            TextField::new('label', "Titre de la Discipline :")->setColumns(6)->hideOnIndex(),
            BooleanField::new("competition")->hideOnIndex(),
            FormField::addRow(""),

            FormField::addFieldset('Cours'),
            CollectionField::new('activityClasses', 'Cours :')->useEntryCrudForm(ActivityClassCrudController::class)->setColumns(8)->hideOnIndex(),
